...
Tiny 4-pillar scaffolding: feedback picks the best program, approximability uses cell accuracy, abstraction stores exact winners, and exploration grows the library by one primitive per round.
